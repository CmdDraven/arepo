...
export function planBetterAuthSessionTokenStoragePolicy(): BetterAuthSessionTokenStoragePolicy {
  return {
    ...
    operatorWarnings: [
      ...
      "Browser sessions remain blocked until internal-adapter wrapper, production plugin, sidecar state, backup/restore, CSRF, and mounting decisions are complete.",
    ],
  };
}
